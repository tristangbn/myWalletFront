...
function AddCrypto(props) {
  ...
  return (
    <Box alignItems="center" h="100" flex={1} px="3" width="100%" _dark={{ bg: "blueGray.900" }}>
      <Box
      p="10"
      pt="10"
      mt="40px"
...
rounded="2xl"
    ...
    <Spacer />
      <Button mb="10" placement="bottom" width="98%" _dark={{ bg: "#480CA8" }} rounded="lg" onPress={() => console.log("hello world")} _text={{
          fontSize: "xl",
          fontWeight: "medium",
          color: "#ffffff",
          letterSpacing: "lg",
        }}>Ajouter une crypto</Button>
